...
`.trimStart(),
  ...
  footer: '┗━━━━━━━━⬣\n',
  after: '*إستخدامك للبوت بشكل صحيح يعني أنك تزيد من إحتمالية أن يبقى البوت شغالا لمدة أطول . لذا إن واجهتك أي مشكلة لا تخجل من سؤال صاحب البوت .رقمه سوف تجده في الأسفل +انضم  الى مجموعة البوت في حالت وقع اي خطا او تغير رقم بوت ادخل لي مجموعة بي استخدام هاد الرابط https://chat.whatsapp.com/CFYmSvidfRz11LkZ1BC1w6*\n+212619008919',
}
...
renderLargerThumbnail: true
    ...
    conn.reply(m.chat, '❎  حاول مرة اخرا هناك خطأ في لائحة الاوامر', m)
    throw e
  }
}
handler.help = ['menu']
